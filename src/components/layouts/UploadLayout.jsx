      ...
      <div className="rounded shadow py-3">
        ...
        <div className="flex justify-between px-2 py-2 transition-all duration-300 border-t border-gray-200">
          {activeButton === 1 ? (
            ...
            <button onClick={} className="px-4 py-2 bg-gray-300 tracking-wider font-semibold rounded hover:bg-gray-300/80 hover:text-black">
              Back
            </button>
          )}
          {activeButton === 3 ? (
            ...
            <button className="px-4 py-2 bg-accent tracking-wider font-semibold rounded hover:bg-accent/80 text-white">
              Next
            </button>
          )}
        </div>
